...
export default function MyBalancePage() {
  ...
  const fetchBalance = async () => {
    try {
      ...
      // API returns data.balances with nested leaveType structure
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <div className="bg-gray-700/50 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-cyan-400">{balance.carryOver}</div>
              ...
              <div className="mt-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-400">Usage Progress (Based on Accrued Balance)</span>
                  <span className="text-sm font-medium text-white">
                    {balance.accrued > 0 
                      ? Math.round(((balance.taken + balance.pending) / balance.accrued) * 100)
                      : 0}% Used
                  </span>
                </div>
                <div className="w-full bg-gray-700 rounded-full h-2.5">
                  <div 
                    ...
                    style={{ 
                      width: `${balance.accrued > 0 
                        ? Math.min(((balance.taken + balance.pending) / balance.accrued) * 100, 100)
                        : 0}%` 
                    }}
                  />
                </div>
